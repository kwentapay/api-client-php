<?php
/**
 * GetOrderByIdResponsePaymentRefundPayment
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * GetOrderByIdResponsePaymentRefundPayment Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetOrderByIdResponsePaymentRefundPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrderByIdResponse_PaymentRefund_Payment';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'paymentMethodType' => '\OpenAPI\Client\Model\PaymentMethodType',
        'cardPaymentMethod' => '\OpenAPI\Client\Model\GetOrderByIdResponsePaymentRefundPaymentCardPaymentMethod'
    ];
    ...
    */
     ...
     *
     * @param \OpenAPI\Client\Model\PaymentMethodType|null $paymentMethodType paymentMethodType
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\GetOrderByIdResponsePaymentRefundPaymentCardPaymentMethod|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\GetOrderByIdResponsePaymentRefundPaymentCardPaymentMethod|null $cardPaymentMethod cardPaymentMethod
     *
     * @return self
     */
