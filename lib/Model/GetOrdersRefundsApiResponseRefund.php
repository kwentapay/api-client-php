...
/**
 * GetOrdersRefundsApiResponseRefund Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetOrdersRefundsApiResponseRefund implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetOrdersRefundsApiResponseRefund';
    ...
    */
    ...
    public function setAmount($amount)
    {
        ...
        if (($amount < 1)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling GetOrdersRefundsApiResponseRefund., must be bigger than or equal to 1.');
        }
     ...
     * Sets refundedAt
     *
     * @param \DateTime $refundedAt refundedAt
     *
     * @return self
     */
