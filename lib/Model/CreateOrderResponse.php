...
class CreateOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets payerId
     *
     * @param string|null $payerId The ID of the payer
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url Web URL of the order. Used to redirect the payer to the order page.
     *
     * @return self
     */
    public function setUrl($url)
    {
        ...
        if ((!preg_match("/^https?:\/\/.+$/", ObjectSerializer::toString($url)))) {
            throw new \InvalidArgumentException("invalid value for \$url when calling CreateOrderResponse., must conform to the pattern /^https?:\/\/.+$/.");
        }
